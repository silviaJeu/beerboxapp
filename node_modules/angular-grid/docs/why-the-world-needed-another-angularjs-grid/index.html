...
<head lang="en">
    ...
    <meta name="description" content="A discussion on why I built Angular Grid after experience with ui-grid, ng-grid, jqxGrid and Slickgrid">
    <meta name="keywords" content="angularjs angular grid ui-grid ng-grid jqxgrid slickgrid"/>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <p>
                ...
                <ul>
                    ...
                    evolutionary prototype of what is now Angular Grid. When drawing the grid, not
            ...
            <p>
                ...
                So I coded up the new grid in time for getting back to work in 2015. I introduced Angular Grid
            ...
            <p>
                Angular Grid has been released as open source for anyone who finds it helpful.
                We are continuing to use it in my work, so you can expect it to be maintained for
                the foreseeable future.
            </p>
            <p>
                And that is the story of Angular Grid. I hope my contribution back to the community
                can help out if you are suffering the same frustration I used to with the grid choices
                for <a href="https://angularjs.org/">AngularJS</a>. I intend continuing with Angular Grid, making it a great choice
        ...
        <div class="col-md-4">
            ...
            <div class="quote-side-panel">
                ...
                <div class="quote-block">
                    <div class="quote">
                        "I have experienced myself the pain with using the out of the box angular grid, and I have to say, this grid looks much better, can't wait to see the new features that will get added."
                    </div>
                    <div class="under-quote">
                ...
                <div class="quote-block">
                    <div class="quote">
                        "This is an awesome idea, Niall."
                    </div>
                    <div class="under-quote">
                        Eric April 5th 2015 via Disqus
                    </div>
                </div>
                ...
                <div class="quote-block">
                    <div class="quote">
                        "I found Angular Grid on the AngularJS subreddit and it's working out great!   I love the speed and the built-in features."
                    </div>
                    <div class="under-quote">
                ...
                <div class="quote-block">
                    <div class="quote">
                        ...
                        I am playing around with your angular grid. And I love it.
                ...
                <div class="quote-block">
                    ...
                    <div class="under-quote">
                        Urvish 27th March 2015 via Angular Grid Forum
                    </div>
                </div>
                ...
                <div class="quote-block">
                    ...
                    <div class="under-quote">
                        Sher 28 March 2015 via Angular Grid Forum
                    </div>
                </div>

                <div class="quote-block">
                    <div class="quote">
                        "Thanks for the great grid and putting up with my posts."
                    </div>
                    <div class="under-quote">
                        Beernutz 1st April 2015 via Angular Grid Forum
                    </div>
                </div>

                <div class="quote-block">
                    <div class="quote">
                        "Thank you first for this great table"
                    </div>
                    <div class="under-quote">
                        Adry 3rs April via Angular Grid Forum
                    </div>
                </div>

                <div class="quote-block">
                    <div class="quote">
                        "The grid looks cool, thanks for doing a great job! "
                    </div>
                    <div class="under-quote">
                        Enanchen 8th April 2015 via Angular Grid Forum
                    </div>
                </div>
                ...
                <div class="quote-block">
                    ...
                    <div class="under-quote">
                        Luis 13th April 2015 via Angular Grid Forum
                    </div>
                </div>
                ...
                <div class="quote-block">
                    ...
                    <div class="under-quote">
                        Jqravois 13th April 2015 via Angular Grid Froum
                    </div>
                </div>

                <div class="quote-block">
                    <div class="quote">
                        "This grid is really good and easy to implement"
                    </div>
                    <div class="under-quote">
                        Sudheer 13th April 2015 via Angular Grid Forum
                    </div>
                </div>

                <div class="quote-block">
                    <div class="quote">
                        "Hi, thank u for this super component!"
                    </div>
                    <div class="under-quote">
                        Osman 14th April 1015 via Angular Grid Forum
                    </div>
                </div>
                ...
                <div class="quote-block">
                    ...
                    <div class="under-quote">
                        Rich 15th April 2015 via Angular Grid Forum
                    </div>
                </div>
